...
public class DialogueManager : MonoBehaviour
{
    ...
    public void PlayOldMan()
    {
        ...
        if (!Singleton.Instance.gameFinished)
        {
            ShowTextBox(new string[] { "Yaşlı Adam: Seni gördüğüme sevindim. Uzun zamandır gelmeni bekliyorum. Umarım senin için gelmek kolay olmuştur. Ben senin içine bulunduğun Anakrobotun mucidiyim. Bu robotu oğlum için yapmıştım fakat onun ruhunu Anakrobota aktarmayı başaramadım. Sen bir mucizesin."
        ...
        {
            ShowTextBox(new string[] { "Yaşlı Adam: Tekrardan hoş geldin. İstediğim taşları toplayabildin mi?"
